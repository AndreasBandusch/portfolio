...
export const DE: Language = {
  ...
  about1:
    'Ich entwickle Frontends für Anwendungen, die täglich von vielen Menschen benutzt werden: Onlineshops, Produktkataloge, Kundenportale. Mein Schwerpunkt liegt auf klarer Architektur und verlässlicher Zustandsverwaltung.',
  about2:
  ...
  privacyBlocks: [
    ...
    },
    {
      ...
      lines: [
        ...
        'Join nutzt Google Firebase für Datenhaltung und Anmeldung; dabei können Daten auf Servern von Google verarbeitet werden. Weitere Angaben finden Sie in den Datenschutzhinweisen des Anbieters. El Pollo Loco läuft vollständig im Browser und ruft keine externen Dienste auf.',
  ...
  projects: [
    ...
    },
    {
      ...
      imageAlt: 'bandusch.com: Hero-Bereich dieser Portfolio-Seite',
      tags: ['Angular 22 zoneless', 'SSR/SSG', 'i18n'],
      desc: 'Diese Portfolio-Seite selbst: Angular 22 zoneless mit Prerendering statt Client-Side-Rendering, damit Suchmaschinen und Link-Vorschauen echtes HTML sehen. Eigener Signal-basierter Translation Service für Deutsch und Englisch, ganz ohne zweiten Build oder Sprach-Routen.',
      liveUrl: '/',
      codeUrl: 'https://github.com/AndreasBandusch/portfolio',
    },
  ],
};
