...
export const EN: Language = {
  ...
  aboutTitle: 'About',
  about1:
    'I build front ends for applications many people use every day: online shops, product catalogs, customer portals. My focus is clear architecture and dependable state management.',
  about2:
  ...
  privacyBlocks: [
    ...
    },
    {
      ...
      lines: [
        ...
        'Join uses Google Firebase for data storage and sign-in, which may involve processing on Google servers. Further details are available in that providers own privacy notice. El Pollo Loco runs entirely in the browser and calls no external services.',
  ...
  projects: [
    ...
    },
    {
      ...
      imageAlt: 'bandusch.com: hero section of this portfolio site',
      tags: ['Angular 22 zoneless', 'SSR/SSG', 'i18n'],
      desc: 'This portfolio site itself: Angular 22 zoneless with prerendering instead of client-side rendering, so search engines and link previews see real HTML. A custom signal-based translation service for German and English, with no second build or language routes.',
      liveUrl: '/',
